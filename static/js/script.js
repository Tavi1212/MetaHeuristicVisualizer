...
const continuousClusteringBtn = document.getElementById('continuous-clustering');

const discreteShannon         = document.getElementById('discrete-entropy-options');
const discreteClustering      = document.getElementById('discrete-clustering-options');
const continuousStd           = document.getElementById('continuous-standard-options');
const continuousClustering    = document.getElementById('continuous-clustering-options');
...
function logAlgorithmDetails() {
    ...
    algorithms.forEach((algorithm, index) => {
        ...
        if (nameInput && nameInput.value.trim() !== "" && fileInput.files.length > 0) {
            valid = true;
...
function submitAllData() {
    ...
    .catch(error => {
        ...
        alert("There was a problem submitting your data. See console for details.");
    });
}
